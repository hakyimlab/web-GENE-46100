...
## Enformer class definition in pytorch
downloaded from [enformer.py](https://github.com/google-deepmind/deepmind-research/blob/master/enformer/enformer.py) annotated with cursor
