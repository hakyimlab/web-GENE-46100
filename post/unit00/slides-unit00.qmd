...
![](assets/gradient-descent-computed.png){fig-align="center" width="90%"}
...
:::: {.column width="50%"}
![](assets/tensorflow-playground.png){width="100%"}
::::
...
digraph training {
  ...
  node [shape=box, style=filled, fillcolor='#e0f2fe',
        color='#0369a1', fontname='Helvetica', fontsize=48, width=2.5, height=1.0, margin='0.35,0.4']
  edge [color='#333333', arrowsize=2.0, penwidth=2.5]

  A [label='Input Data', fillcolor='#f0f9ff']
  B [label='Forward Pass\nmodel(x)']
  C [label='Compute Loss\nloss_fn(y_hat, y)']
  D [label='Backward Pass\nloss.backward()']
  E [label='Update Params\noptimizer.step()']
