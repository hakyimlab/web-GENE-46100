...
# Copy the name (not the path) for the environment that you created with the
...
# now you can run quarto render and it will be rendered with the conda environment you specified
