...
Create sc46100 env cloning gene46100
`conda create --name sc46100 --clone gene46100`
...
# Convert canonical_marker to boolean if it's string
if markers["canonical_marker"].dtype == 'object':
    markers["canonical_marker"] = markers["canonical_marker"].map({'True': True, 'False': False})
